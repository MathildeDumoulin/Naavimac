...
/***** CONSTRUCTORS & DESTRUCTOR *****/
    ...
    Instance::Instance(const unsigned int nbInstances, const Object& obj, const std::string& diffuseFp) 
        : m_vao(0), m_buffer(0), m_offsetPosition(nbInstances), m_nbIndexPerObj(obj.nbIndex()), m_diffuseTexture(0) {
...
/***** PRIVATE METHODS *****/
    ...
    void Instance::loadTextures(const std::string& diffuseFp) {
        //DIFFUSE TEXTURE
            //Image loading
